export default function Facilidades() {
  return (
    <div className="bg-black pb-9 mt-[100px]">
      ...
      <div className="text-white flex-col flex items-center md:gap-4 ml-10 md:flex md:flex-row md:justify-center md:w-full md:items-center max-sm:pl-6 max-sm:w-[360px]">
        <div className="flex items-center md:justify-center md:mb-0 gap-6 mb-10 max-sm:w-full max-md:w-[400px]">
          <img
        ...
        <div className="flex items-center md:justify-center md:mb-0 gap-6 mb-5 max-sm:w-full max-md:w-[400px]">
          <img
